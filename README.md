...
Amazon Power BI Project.pbix — The complete Power BI dashboard file.

# 🖥️ Dashboard Preview
Note: To explore the dashboard, open the .pbix file in Power BI Desktop.
...
5. Growth Analysis with KPIs

# 📈 Sample Metrics & Insights
1. Total Sales (2012–2015)
2. Top 5 Product Categories
3. YOY Growth % by Region
4. Revenue by Country (Choropleth Map)
5. Quarter-over-Quarter Trendlines

# 🚀 How to Use
● Download and install Power BI Desktop.
● Clone this repo or download the ```.pbix``` file directly.
